...
class ClassificationDataset(Dataset):
    def __init__(self, config, vocab, stage='TRAIN', on_memory=True, corpus_lines=None, mode="TRAIN", tokenizer=None, tokenized=False):
        """
    ...
    def create_features(self, sentences, max_seq_len=256):
        feature = self.tokenizer(sentences, padding='max_length', truncation=True, max_length=max_seq_len, return_tensors='pt')
