...
class StructureEncoder(nn.Module):
    def __init__(self,
        ...
        self.hierarchical_label_dict = get_hierarchy_relations(hierar_taxonomy=os.path.join(config.data.data_dir,
                                                                                              config.data.hierarchy),
                                                                                 label_map=self.label_map,
                                                                                 root=self.root,
                                                                                 fortree=False, 
                                                                                 add_root_relation=False)
        # self.hierarchical_label_dict, self.label_trees = get_hierarchy_relations(hierar_taxonomy=os.path.join(config.data.data_dir,
        #                                                                                       config.data.hierarchy),
        #                                                                          label_map=self.label_map,
        #                                                                          root=self.root,
        #                                                                          fortree=True, 
